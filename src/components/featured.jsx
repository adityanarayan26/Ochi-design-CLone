        ...
        <div data-scroll data-scroll-section className='w-full py-20 rounded-tl-3xl rounded-tr-3xl  '>
            ...
            <div className="card-main-container w-full  px-10  mt-32  ">
                ...
                <div className="cardcontainer relative flex justify-between gap-10 py-10" >
                    ...
                    {/* <div className='absolute text-[#CDEA68] text-[7vw] uppercase font-bold leading-none top-1/2 -translate-y-[3vw]  left-1/2 -translate-x-[7vw] font-["Neue_Montreal"] tracking-tight'>{"trawa".split("").map((item, index) => (<span className=''>{item}</span>))}</div> */}
